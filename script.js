...
function renderSignature(block) {
  document.getElementById("signature").innerHTML = `
    ...
    <div class="signature-cover"><video src="${block.cover.video}" poster="${block.cover.poster}" controls playsinline preload="metadata" aria-label="${block.cover.alt}"></video></div>`;
}
